<template>
    <div class="components-container">
        ...
        <el-table :data="tableData" v-loading.body="tableLoading" element-loading-text="拼命加载中" stripe border fit highlight-current-row style="width: 100%">
            <el-table-column label="公告ID" prop="id" align="center"></el-table-column>
            <el-table-column label="公告发布单位" prop="department" align="center"></el-table-column>
            <el-table-column label="公告标题" prop="title" align="center"></el-table-column>
            <el-table-column label="公告图片" prop="pic" align="center"></el-table-column>
            <el-table-column label="公告类型 0-默认公告信息, 1-首页公告" prop="type" align="center"></el-table-column>
            <el-table-column label="公告排序" prop="sort" align="center"></el-table-column>
            <el-table-column label="公告置顶 1-置顶" prop="isTop" align="center"></el-table-column>
        ...
        <el-dialog :title="formTitle" :visible.sync="formVisible" width="35%">
            <el-form :model="createdForm" label-position="left" label-width="70px" style="width: 80%; margin-left:0px;">
                <el-form-item label="公告发布单位">
                    <el-input v-model="createdForm.department" placeholder="请填写公告发布单位"></el-input>
                </el-form-item>
                <el-form-item label="公告标题">
                    <el-input v-model="createdForm.title" placeholder="请填写公告标题"></el-input>
                </el-form-item>
                <el-form-item label="公告图片">
                    <el-input v-model="createdForm.pic" placeholder="请填写公告图片"></el-input>
                </el-form-item>
                <el-form-item label="公告类型 0-默认公告信息, 1-首页公告">
                    <el-input v-model="createdForm.type" placeholder="请填写公告类型 0-默认公告信息, 1-首页公告"></el-input>
                </el-form-item>
                <el-form-item label="公告排序">
                    <el-input v-model="createdForm.sort" placeholder="请填写公告排序"></el-input>
                </el-form-item>
                <el-form-item label="公告置顶 1-置顶">
                    <el-input v-model="createdForm.isTop" placeholder="请填写公告置顶 1-置顶"></el-input>
                </el-form-item>
                <el-form-item label="公告内容">
                    <el-input v-model="createdForm.content" placeholder="请填写公告内容"></el-input>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            clearDialog() {
                ...
                this.createdForm.department = null;
                this.createdForm.title = null;
                this.createdForm.pic = null;
                this.createdForm.type = null;
                this.createdForm.sort = null;
                this.createdForm.isTop = null;
                this.createdForm.content = null;
            },
