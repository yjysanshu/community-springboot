<template>
    <div class="components-container">
        ...
        <el-table :data="tableData" v-loading.body="tableLoading" element-loading-text="拼命加载中" stripe border fit highlight-current-row style="width: 100%">
            ...
            <el-table-column label="资源id" prop="adminResourceId" align="center"></el-table-column>
            <el-table-column label="角色id" prop="adminRoleId" align="center"></el-table-column>
            <el-table-column label="权限类型 all-全部 access-访问 manage-管理" prop="type" align="center"></el-table-column>
        ...
        <el-dialog :title="formTitle" :visible.sync="formVisible" width="35%">
            <el-form :model="createdForm" label-position="left" label-width="70px" style="width: 80%; margin-left:0px;">
                <el-form-item label="资源id">
                    <el-input v-model="createdForm.adminResourceId" placeholder="请填写资源id"></el-input>
                </el-form-item>
                <el-form-item label="角色id">
                    <el-input v-model="createdForm.adminRoleId" placeholder="请填写角色id"></el-input>
                </el-form-item>
                <el-form-item label="权限类型 all-全部 access-访问 manage-管理">
                    <el-input v-model="createdForm.type" placeholder="请填写权限类型 all-全部 access-访问 manage-管理"></el-input>
                </el-form-item>
    ...
    export default {
        ...
        methods: {
            getList() {
                ...
                this.$api.module.adminPrivilege.list({
            ...
            clearDialog() {
                ...
                this.createdForm.adminResourceId = null;
            ...
            commitForm() {
                ...
                this.$api.module.adminPrivilege.save({
            ...
            deleteRecord(id) {
                confirmBox('[[]]').then(() => {
                    ...
                    this.$api.module.adminPrivilege.delete({
