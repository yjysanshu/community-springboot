...
public class MapperXmlService extends BaseService {
    ...
    protected void generator() {
        ...
        sb.append(MapperConst.TXT_XML.replaceAll(MapperConst.REPLACE_RESULT_MAP_LINE, sbResult.toString())
                ...
                .replaceAll(MapperConst.REPLACE_TABLE_NAME, tableName));
    }
    ...
    protected String getPath() {
        if (this.path == null) {
            this.path = System.getProperty("user.dir") + MapperConst.DIR_SPLIT + MapperConst.PATH_INNER_RESOURCE
                    +  MapperConst.PATH_INNER_MAPPER_XML;
        }
        return this.path;
    }
