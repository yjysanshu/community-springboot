...
public class ModelConst extends CommonConst {
    ...
    public static final String COMMON_MODEL_PACKAGE = ".common.models";

    public static final String PACKAGE_ADMIN_REQUEST = ".admin.models.request";
    public static final String PACKAGE_ADMIN_RESPONSE = ".admin.models.response";
