...
public class VueConst extends CommonConst {
    ...
    public static final String REPLACE_SEARCH_COLUMN = "\\[searchColumn\\]";
    ...
    public static final String TXT_SEARCH_INPUT = "            <el-input v-model=\"tableQuery.[columnNameRe]\" @keyup.enter.native=\"handleFilter\" style=\"width: 200px;\" placeholder=\"[columnComment]\"></el-input>\n";
